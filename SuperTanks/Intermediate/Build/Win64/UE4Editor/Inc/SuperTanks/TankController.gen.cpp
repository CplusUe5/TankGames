...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATankController_Statics::NewProp_MousePos_MetaData[] = {
		{ "ModuleRelativePath", "TankController.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_ATankController_Statics::NewProp_MousePos = { "MousePos", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ATankController, MousePos), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_ATankController_Statics::NewProp_MousePos_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATankController_Statics::NewProp_MousePos_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATankController_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATankController_Statics::NewProp_MousePos,
	};
	...
	IMPLEMENT_CLASS(ATankController, 1124779194);
